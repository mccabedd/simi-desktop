...
**Simple Image Metadata Inspector** — a tiny (~200Kb), portable Windows app for inspecting the embedded metadata of PNG images generated by [ComfyUI](https://github.com/comfyanonymous/ComfyUI).
